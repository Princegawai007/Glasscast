...
//            Text(text).font(.display(size: 13, weight: .medium)).foregroundColor(.white)
//        }
//        .padding(.horizontal, 16).padding(.vertical, 10)
//        .background(Capsule().fill(Color.white.opacity(0.1)).overlay(Capsule().stroke(Color.white.opacity(0.1), lineWidth: 1)))
//    }
//    
//    func forecastRow(day: DailyForecastItem) -> some View {
...
//                    Spacer()
//                    Image(systemName: "cloud.fill")
//                        .renderingMode(.original).font(.title3).foregroundColor(.white.opacity(0.8))
//                    Spacer()
//                    HStack(spacing: 12) {
//                        Text("\(day.maxTemp)°").font(.display(size: 16, weight: .bold)).foregroundColor(.white)
//                        Text("\(day.minTemp)°").font(.display(size: 16, weight: .regular)).foregroundColor(.white.opacity(0.4))
//                    }
//                    .frame(width: 80, alignment: .trailing)
//                }
//                .padding(16)
...
//        GlassEffectContainer(cornerRadius: 16) {
//            Map(coordinateRegion: $mapRegion)
//                .frame(height: 200).cornerRadius(16).colorScheme(.dark)
...
//    private func updateMapRegion() {
//        if let location = viewModel.currentWeather?.coord {
//            mapRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: location.lat, longitude: location.lon), span: MKCoordinateSpan(latitudeDelta: 0.1, longitudeDelta: 0.1))
//        }
//    }
//}
